...
bvh_include_dirs = torch.utils.cpp_extension.include_paths() + [
    'include',
    '/lustre06/project/6098542/xinxin/cuda-samples-12.2/Common/'] #please download the cuda-samples from https://developer.nvidia.com/cuda-downloads and change the path accordingly
